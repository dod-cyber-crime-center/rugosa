...
@opcode("fsubp")
@opcode("fsubrp")
def _compute(cpu_context: ProcessorContext, instruction: Instruction):
...
@opcode
def FCHS(cpu_context: ProcessorContext, instruction: Instruction):
...
@opcode("ficomp")
@opcode("ftst")
def FCOM(cpu_context: ProcessorContext, instruction: Instruction):
...
@opcode("fcmovnbe")
@opcode("fcmovnu")
def FCMOV(cpu_context: ProcessorContext, instruction: Instruction):
...
@opcode("fldlg2")
@opcode("fldln2")
def FLD(cpu_context: ProcessorContext, instruction: Instruction):
...
@opcode
def FLDCW(cpu_context: ProcessorContext, instruction: Instruction):
...
@opcode("fist")
@opcode("fistp")
def FST(cpu_context: ProcessorContext, instruction: Instruction):
...
@opcode("fstcw")
@opcode("fnstcw")
def FSTCW(cpu_context: ProcessorContext, instruction: Instruction):
...
@opcode
def FXAM(cpu_context: ProcessorContext, instruction: Instruction):
...
@opcode
def FXCH(cpu_context: ProcessorContext, instruction: Instruction):
...
@opcode
def SAHF(cpu_context: ProcessorContext, instruction: Instruction):
